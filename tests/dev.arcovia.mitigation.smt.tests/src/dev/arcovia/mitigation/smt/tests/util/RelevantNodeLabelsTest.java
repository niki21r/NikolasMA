...
class RelevantNodeLabelsTest extends UtilTestBase {
	...
	void testGetRelevantNodeLabelsAdd(List<String> withoutSingleFrom, List<List<String>> withoutMultiFrom,
			List<String> withSingleFrom, List<List<String>> withMultiFrom, List<String> withoutSingleTo,
			List<List<String>> withoutMultiTo, List<String> withSingleTo, List<List<String>> withMultiTo,
			Set<String> expectedAddNames, Set<String> expectedRemoveNames) {

		var ctx = buildConstraintAndDictionary(withoutSingleFrom, withoutMultiFrom, withSingleFrom, withMultiFrom,
				withoutSingleTo, withoutMultiTo, withSingleTo, withMultiTo);
	...
	@ParameterizedTest
	@MethodSource("nodeConstraintParameters")
	void testGetRelevantNodeLabelsRemove(List<String> withoutSingleFrom, List<List<String>> withoutMultiFrom,
			List<String> withSingleFrom, List<List<String>> withMultiFrom, List<String> withoutSingleTo,
			List<List<String>> withoutMultiTo, List<String> withSingleTo, List<List<String>> withMultiTo,
			Set<String> expectedAddNames, Set<String> expectedRemoveNames) {
	...
	private Ctx buildConstraintAndDictionary(List<String> withoutSingleFrom, List<List<String>> withoutMultiFrom,
			List<String> withSingleFrom, List<List<String>> withMultiFrom, List<String> withoutSingleTo,
			List<List<String>> withoutMultiTo, List<String> withSingleTo, List<List<String>> withMultiTo) {
		...
		var toBuilder = fromBuilder.neverFlows().toVertex();
	...
	static Stream<Arguments> nodeConstraintParameters() {
		return Stream.of(
				...
				Arguments.of(List.of("B"), List.of(List.of("B", "C")), List.of(), List.of(), List.of(), List.of(),
						List.of(), List.of(), Set.of("B", "C"), Set.of()),
				// 2) only WITH on fromVertex -> Add: {}, Remove: {B,C}
				Arguments.of(List.of(), List.of(), List.of("B"), List.of(List.of("B", "C")), List.of(), List.of(),
						List.of(), List.of(), Set.of(), Set.of("B", "C")),
				// 3) only WITHOUT on toVertex -> Add: {D,E}, Remove: {}
				Arguments.of(List.of(), List.of(), List.of(), List.of(), List.of("D"), List.of(List.of("D", "E")),
						List.of(), List.of(), Set.of("D", "E"), Set.of()),
