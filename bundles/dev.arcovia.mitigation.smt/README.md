...
Then click finish.
3.5 Generate Model code for Dataflowdiagrams and Datadictionarys
...
File -> Open Projects from File System -> Directory... -> Select NikolasMA -> Open -> Deselect all -> Manually select
